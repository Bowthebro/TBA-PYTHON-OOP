...
class Player:
    ...
    def player_take_damage(self, enemy):
        player_damage_messages = ["teeth", "face", "eye", "testicle"]
        self.player_health = self.player_health - enemy.enemy_damage
        print("The %s" % enemy.enemy_name, "charges forward and your %s is mutilated"
...
class Enemy:
    ...
    def enemy_take_damage(self, player):
        enemy_damage_messages = ["chin", "mouth", "ass"]
...
Commands = "go 'direction', look, take 'item', 'inventory', drop 'item' unlock and exit (to exit the game)"
...
# begins sword sequence (temp disabled for debugging)
# sword_sequence()
...
while User_Input != "exit":
    ...
    while the_player.player_health > 0:
        ...
        elif "introspect" in User_Input:
            print("Your health is", the_player.player_health)
